    ...
    <div className="p-3 bg-surface-secondary rounded-xl border border-border">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-semibold text-text-primary leading-none">{title}</div>
            <div className="text-xs text-text-muted mt-0.5">Level {level}</div>
          </div>
        </div>
        <div className="text-right">
          <span className="text-xs font-medium text-text-primary">{xp}</span>
          <span className="text-xs text-text-muted">/{xpNeeded}</span>
        </div>
      </div>
