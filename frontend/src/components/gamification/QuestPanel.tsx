      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-96 bg-white border-l border-border shadow-modal z-50 flex flex-col"
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
              <div className="flex items-center gap-2">
                <Target className="w-5 h-5 text-text-primary" />
                <h2 className="font-semibold text-text-primary">Active Quests</h2>
              </div>
              <button
                onClick={onClose}
                ...
                filteredQuests.map(quest => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className={cn(
                            ...
                            quest.completed ? 'text-text-secondary line-through' : 'text-text-primary'
                          )}>
                            {quest.title}
                          </h3>
                        </div>
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0 bg-accent-light rounded-full px-2 py-0.5">
                        <Zap className="w-3 h-3 text-text-primary" />
                        <span className="text-xs font-bold text-text-primary">+{quest.xp_reward}</span>
                      </div>
                    </div>
