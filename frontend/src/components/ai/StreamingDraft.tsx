        ...
        <div className="flex items-center gap-3">
          {isStreaming ? (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-text-primary">Generating...</span>
            </div>
          ) : error ? (
            <div className="flex items-center gap-2">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div className={cn(
                  ...
                  section.complete ? 'bg-accent text-white' : 'bg-border text-text-muted'
                )}>
                  {section.complete ? '✓' : i + 1}
                </div>
                <h4 className="text-sm font-semibold text-text-primary">{section.title}</h4>
              </div>
              <div className="pl-7 text-sm text-text-secondary leading-relaxed">
                {section.content}
