        ...
        <div className="flex-1 min-w-0">
          {activeTab === 'profile' && (
            <div className="bg-white rounded-xl border border-border p-6 space-y-5">
              <h2 className="font-semibold text-text-primary">Profile Settings</h2>
          ...
          {activeTab === 'brand-kits' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="font-semibold text-text-primary">Brand Kits</h2>
              ...
              <div className="text-center py-16 bg-white rounded-xl border border-border">
                ...
                <p className="text-text-primary font-medium">No brand kits yet</p>
                <p className="text-text-muted text-sm mt-1">Create brand kits to customize your export styles</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <Modal isOpen={showInviteModal} onClose={() => setShowInviteModal(false)} title="Invite Team Member" size="sm">
                <div className="p-5 space-y-4">
                  ...
                  />
                  <div>
                    <label className="text-sm font-medium text-text-primary block mb-1.5">Role</label>
              ...
              <div className="bg-white rounded-xl border border-red-200 p-6 space-y-3">
                ...
                <div className="flex items-center justify-between py-3 border-b border-border">
                  <div>
                    ...
                    <p className="text-xs text-text-muted">Download a copy of all your data</p>
                  </div>
