  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <motion.div initial="hidden" animate="visible" variants={fadeUp} className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">LinkedIn Publish</h1>
          <p className="text-slate-300 mt-1">Schedule and publish your HC insights</p>
        </div>
        ...
        {isConnected ? (
          ...
          <div className="flex items-center gap-3 p-4 bg-[#131720] border border-[#1e2433] rounded-xl">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-600">Connect your account to publish directly</p>
            </div>
