  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <motion.div initial="hidden" animate="visible" variants={fadeUp}>
        ...
        <p className="text-slate-300 mt-1">Download and publish your generated deliverables</p>
      </motion.div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#1e2433] bg-[#0E0E0E]">
                ...
                <th className="text-left text-xs font-semibold text-slate-600 px-4 py-3 hidden sm:table-cell">Brand Kit</th>
                ...
                return (
                  <tr key={exp.id} className="border-b border-[#1e2433] last:border-0 hover:bg-[#0E0E0E] transition-colors">
                    ...
                    <td className="px-4 py-3 hidden sm:table-cell">
                      <span className="text-sm text-slate-600">{exp.brand_kit_name || 'Default'}</span>
                    </td>
                    <td className="px-4 py-3 hidden sm:table-cell">
                      <span className="text-sm text-slate-600">{formatDate(exp.created_at)}</span>
                    </td>
                    <td className="px-4 py-3">
