      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-96 bg-[#1B2431] border-l border-[#2A3648] shadow-[0_25px_60px_rgba(0,0,0,0.8)] z-50 flex flex-col"
          >
            ...
            <div className="flex gap-1 px-5 py-3 border-b border-[#2A3648]">
                ...
                filteredQuests.map(quest => (
                  <div
                    ...
                    className={cn(
                      ...
                      quest.completed
                        ? 'border-[#2A3648] bg-[#0E0E0E]'
                        : 'border-[#2A3648] bg-[#1B2431]'
                    )}
                  >
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0 bg-[#2E7DFA]-light rounded-full px-2 py-0.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="h-1.5 bg-border rounded-full overflow-hidden">
                        <div
                          className="h-full bg-[#2E7DFA] rounded-full transition-all duration-500"
